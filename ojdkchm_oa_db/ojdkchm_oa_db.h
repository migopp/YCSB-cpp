...
#include "core/db.h"
#include <kvstore/openjdk_concurrent_hash_map_oa.h>

namespace ycsbc {

class ojdkchm_oa_db : public DB {
  public:
    ojdkchm_oa_db() = default;

    ojdkchm_oa_db(const utils::Properties &props);

    virtual ~ojdkchm_oa_db() = default;
  ...
  private:
    static kvstore::concurrent_hash_map_oa _map;
};
