...
#define KVSTORE_OJDKCHM_OA_IMPL
#include "ojdkchm_oa_db.h"

#include <cassert>

namespace ycsbc {

ojdkchm_oa_db::ojdkchm_oa_db(const utils::Properties &props) {}

DB::Status ojdkchm_oa_db::Read(const std::string &table, const std::string &key,
...
DB::Status ojdkchm_oa_db::Scan(const std::string &table, const std::string &key,
...
DB::Status ojdkchm_oa_db::Update(const std::string &table,
...
DB::Status ojdkchm_oa_db::Insert(const std::string &table,
                                 const std::string &key,
                                 std::vector<Field> &values) {
...
DB::Status ojdkchm_oa_db::Delete(const std::string &table,
                                 const std::string &key) {
...
kvstore::concurrent_hash_map_oa ojdkchm_oa_db::_map;
