...
#include "core/db.h"
#include <kvstore/go_sync_map_ii.h>

namespace ycsbc {

class gsm_ii_db : public DB {
  public:
    gsm_ii_db() = default;

    gsm_ii_db(const utils::Properties &props);

    virtual ~gsm_ii_db() = default;
  ...
  private:
    static kvstore::sync_map_ii _map;
};
