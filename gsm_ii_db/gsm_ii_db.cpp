...
gsm_ii_db::gsm_ii_db(const utils::Properties &props) {}
...
DB::Status gsm_ii_db::Scan(const std::string &table, const std::string &key,
...
DB::Status gsm_ii_db::Update(const std::string &table, const std::string &key,
                             std::vector<Field> &values) {
    _map.set(key, values[0].value);
    return kOK;
}

DB::Status gsm_ii_db::Insert(const std::string &table, const std::string &key,
                             std::vector<Field> &values) {
    _map.set(key, values[0].value);
    return kOK;
}

DB::Status gsm_ii_db::Delete(const std::string &table, const std::string &key) {
    _map.remove(key);
    return kOK;
}

kvstore::sync_map_ii gsm_ii_db::_map;
