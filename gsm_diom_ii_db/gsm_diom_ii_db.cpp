...
gsm_diom_ii_db::gsm_diom_ii_db() {}

void gsm_diom_ii_db::Init() {
...
DB::Status gsm_diom_ii_db::Read(const std::string &, const std::string &key,
...
DB::Status gsm_diom_ii_db::Insert(const std::string &, const std::string &key,
...
DB::Status gsm_diom_ii_db::Update(const std::string &, const std::string &key,
                                  std::vector<Field> &values) {
...
DB::Status gsm_diom_ii_db::Delete(const std::string &, const std::string &key) {
    readOnlyMapEntryReturn entryFoundFromReadOnly =
        getEntryFromReadOnlyMap(key);
    if (entryFoundFromReadOnly.entry != nullptr) {
