...
#include "core/db.h"
#include <kvstore/go_sync_map_diom.h>

namespace ycsbc {

class gsm_diom_db : public DB {
  public:
    gsm_diom_db() = default;

    gsm_diom_db(const utils::Properties &props);

    virtual ~gsm_diom_db() = default;
  ...
  private:
    static kvstore::sync_map_diom _map;
};
